...
def get_regression_dataloaders(batch_size, tar_dir_l, rating_fpa, no_train=False, tar_set_idx=None):
    ...
    if no_train:
        ...
        train_data_generator = th_data.DataLoader(train_set, shuffle=True,
                                                  batch_size=batch_size)  # , sampler=torch.utils.data.RandomSampler()
...
def get_para():
    ...
    args.checkpoints_dir = '/home/tech/Workspace/Data/Project_tmp/Facelift/evaluator_arcface/rst/210910_no_classificaiton'
...
if __name__ == '__main__':
    ...
    for tar_set_idx in range(5):
        ...
        for i in range(loaded_epoch+1, args.max_epoch):  #!!! Make sure the class number is right!!!
            ...
            log_l.append([('dataset_group', tar_set_idx), ('epoch', i), ('sum_loss_reg', sum_loss_reg)]) # sum_loss_classs, # sum_acc
            ...
            scheduler.step()
            # np.save('no_classification_training_log', log_l)
